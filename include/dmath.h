...
//MX28AT舵机属性值(12V)
#define AngleRange	  (float)(300.0)       //舵机运动的角度范围
#define PositionRange (float)(1024.0)	   //舵机运动的刻度范围
#define PositionUnit  (float)(0.29296875) //舵机每个刻度对应0.29°
#define SpeedRange    (float)(114.00)      //速度最大为114rpm
#define SpeedUnit     (float)(0.11143695) //每个刻度对应0.111rpm
